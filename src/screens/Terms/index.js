...
class Terms extends Component {
  ...
  onClickBackButton = () => {
		this.dropdown.alertWithType('warn','Atenção', 'É necessário concordar com os termos de uso para prosseguir')
  };
      ...
      <Container style={styles.container} pointerEvents={isLoading ? 'none' : 'auto'}>
        ...
        {isLoading ? (
          <Spinner />
					...
					<View>
						<TouchableOpacity onPress={this.handleTerms} style={{ backgroundColor: "#54fa2a", marginVertical: 15, marginHorizontal: 15 }}>
